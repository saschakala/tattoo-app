...
5.times do
    Artist.create(name: Faker::FunnyName.three_word_name , years_experience: rand(1..15), 
        ...
        username: Faker::Internet.username, email: Faker::Internet.email, password: "password")
end

15.times do
    Tattoo.create(image: Faker::Games::Zelda.character, size: ["small", "medium", "large"].sample, 
    color: ["red", "black and white", "blue", "purple"].sample, user_id: rand(1..5), artist_id: rand(1..5))
    end
